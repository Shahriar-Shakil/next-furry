              ...
              <div className="menu--product-categories">
                ...
                <div className="menu__content">
                  <ul className="menu--dropdown">
                    ...
                    <li className="current-menu-item ">
                      <a href="#">
                        <i className="icon-diamond2" /> Yewelry &amp; Watches
                      </a>
                    </li>
                    <li className="current-menu-item menu-item-has-children has-mega-menu">
                      <a href="#">
                        <i className="icon-desktop" /> Computer &amp; Technology
                      </a>
                      <div className="mega-menu">
                        <div className="mega-menu__column">
                          <h4>
              ...
              >
                <div className="form-group--icon">
                  ...
                  <select className="form-control">
                    ...
                    <option className="level-0" value="cars-motocycles">
                      Cars &amp; Motocycles
                    </option>
                    <option className="level-0" value="clothing-apparel">
                      Clothing &amp; Apparel
                    </option>
                    <option
                      className="level-1"
                      value="accessories-clothing-apparel"
                    >
                      &nbsp;&nbsp;&nbsp;Accessories
                    </option>
                    ...
                    <option className="level-1" value="kids-fashion">
                      &nbsp;&nbsp;&nbsp;Kid’s Fashion
                    </option>
                    ...
                    <option className="level-1" value="womens">
                      &nbsp;&nbsp;&nbsp;Womens
                    </option>
                    <option className="level-0" value="computers-technologies">
                      Computers &amp; Technologies
                    </option>
                    <option className="level-1" value="desktop-pc">
                      &nbsp;&nbsp;&nbsp;Desktop PC
                    </option>
                    ...
                    <option className="level-0" value="consumer-electrics">
                      Consumer Electrics
                    </option>
                    <option className="level-1" value="air-conditioners">
                      &nbsp;&nbsp;&nbsp;Air Conditioners
                    </option>
                    <option className="level-2" value="accessories">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Accessories
                    </option>
                    <option className="level-2" value="type-hanging-cell">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type Hanging Cell
                    </option>
                    <option className="level-2" value="type-hanging-wall">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type Hanging Wall
                    </option>
                    ...
                    <option className="level-2" value="home-theater-system">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home Theater System
                    </option>
                    <option className="level-2" value="speakers">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Speakers
                    </option>
                    <option className="level-1" value="car-electronics">
                      &nbsp;&nbsp;&nbsp;Car Electronics
                    </option>
                    <option className="level-2" value="audio-video">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Audio &amp; Video
                    </option>
                    <option className="level-2" value="car-security">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Car Security
                    </option>
                    <option className="level-2" value="radar-detector">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Radar Detector
                    </option>
                    <option className="level-2" value="vehicle-gps">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vehicle GPS
                    </option>
                    <option className="level-1" value="office-electronics">
                      &nbsp;&nbsp;&nbsp;Office Electronics
                    </option>
                    ...
                    <option className="level-2" value="scanners">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Scanners
                    </option>
                    <option className="level-2" value="store-business">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Store &amp; Business
                    </option>
                    ...
                    <option className="level-1" value="washing-machines">
                      &nbsp;&nbsp;&nbsp;Washing Machines
                    </option>
                    <option className="level-2" value="type-drying-clothes">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type Drying Clothes
                    </option>
                    ...
                    <option className="level-1" value="garden-tools">
                      &nbsp;&nbsp;&nbsp;Garden Tools
                    </option>
                    <option className="level-1" value="home-improvement">
                      &nbsp;&nbsp;&nbsp;Home Improvement
                    </option>
                    <option className="level-1" value="powers-and-hand-tools">
                    ...
                    <option className="level-1" value="hair-care">
                      &nbsp;&nbsp;&nbsp;Hair Care
                    </option>
                    <option className="level-1" value="perfumer">
                      &nbsp;&nbsp;&nbsp;Perfumer
                    </option>
                    ...
                    <option className="level-1" value="gemstone-jewelry">
                      &nbsp;&nbsp;&nbsp;Gemstone Jewelry
                    </option>
                    <option className="level-1" value="mens-watches">
                      &nbsp;&nbsp;&nbsp;Men’s Watches
                    </option>
                    <option className="level-1" value="womens-watches">
                      &nbsp;&nbsp;&nbsp;Women’s Watches
                    </option>
                    <option className="level-0" value="phones-accessories">
                      Phones &amp; Accessories
                    </option>
                    <option className="level-1" value="iphone-8">
                      &nbsp;&nbsp;&nbsp;Iphone 8
                    </option>
                    <option className="level-1" value="iphone-x">
                      &nbsp;&nbsp;&nbsp;Iphone X
                    </option>
                    <option className="level-1" value="sam-sung-note-8">
                      &nbsp;&nbsp;&nbsp;Sam Sung Note 8
                    </option>
                    <option className="level-1" value="sam-sung-s8">
                      &nbsp;&nbsp;&nbsp;Sam Sung S8
                    </option>
                  ...
                  <div className="mega-menu">
                    ...
                    <div className="mega-menu__column">
                      ...
                      <ul className="mega-menu__list">
                        ...
                        <li className="current-menu-item ">
                          <a href="checkout-2.html">Checkout 2</a>
                        </li>
                        <li className="current-menu-item ">
